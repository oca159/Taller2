...
<html lang="en">
	<head>
		...
		<title>@yield('title','Biblioteca Online')</title>
		...
		@section('collection_container_body')
		        <ul class="collection with-header">
		            ...
		            <li class="collection-item">
		                ...
		                @endif
						@if (Auth::guest() || Auth::user()->tipo == 'encargado' )
						...
						@else
			                <div class="horizontal-action-menu right row">
			                	<div class="col s3">
			                        <a id="crear" href=@yield('url_create') class="btn-floating tooltipped green" data-position="top" data-delay="5" data-tooltip="Crear"><i class="large mdi-content-add"></i></a>
			                    </div>
			                    <div class="col s3">
			                        <a id="editar" href="#" class="btn-floating tooltipped disabled" data-position="top" data-delay="5" data-tooltip="Editar"><i class="large mdi-editor-mode-edit"></i></a>
								</div>
			                    <div class="col s3">
			                        <a id="ver" href="#modal1" class="modal-trigger btn-floating tooltipped disabled" data-position="top" data-delay="5" data-tooltip="ver"><i class="large mdi-action-search"></i></a>
								</div>
								<div class="col s3">
			                        <a id="eliminar" href="#modal_delete" class="modal-trigger btn-floating tooltipped disabled" data-position="top" data-delay="5" data-tooltip="Eliminar"><i class="large mdi-action-delete"></i></a>
								</div>
			                </div>
						@endif
		                @yield('partials')
